...
import com.teachgram.backend.domain.user.userDTO.UserProfileDTO;
import com.teachgram.backend.domain.user.userDTO.UpdateUserDTO;
...
public class UserService {
    ...
    public ResponseEntity detailUser(String username, Long loggedInUserId) {
        ...
        UserProfileDTO userProfile = new UserProfileDTO(user, postCount, friendCount, friends);

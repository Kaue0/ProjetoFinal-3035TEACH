    ...
    useEffect(() => {
        async function fetchPost() {
            try {
                ...
                setPhoto_link(postData.photo_Link);
            } catch (error) {
        ...
        <div className="flex flex-col h-screen max-w-[580px] lg:max-w-full lg:self-stretch">
            <div className="flex justify-between items-center px-[30px] min-h-[77px]">
                <div className="flex items-center">
                    ...
                    <h1 className="text-[20px] font-semibold p-8 ml-[28px]">Editar publicação</h1>
                </div>
            ...
            <div className="flex flex-col flex-grow">
                    <div className="flex justify-center">
                        <img src={photo_link} alt="" className="max-w-full max-h-[650px] object-cover lg:max-h-[430px]" />
                    </div>
                    <textarea
